...
public class Result_page5 {
	...
	@FindBy(xpath = "//div[contains(text(),'49 matching Health')]") private WebElement gettingText;
	@FindBy(id = "plans-list") private List<WebElement> allPlaneList;
	@FindBy(xpath = "//div[text()='Sort Plans']")private WebElement softPlanField;
	...
	public boolean softPlanPresency()
	{
		boolean result1 = softPlanField.isDisplayed();
		return  result1;
	}
